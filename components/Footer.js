      ...
      <footer className="text-gray-400 bg-gray-900 body-font">
          ...
          <div className="flex flex-wrap md:text-left text-center order-first">
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
              ...
              <nav className="list-none mb-10">
                <li>
                  <a href="https://google.com" className="text-gray-400 hover:text-white">First Link</a>
                </li>
                <li>
                  <a href="https://google.com" className="text-gray-400 hover:text-white">Second Link</a>
                </li>
                <li>
                  <a href="https://google.com" className="text-gray-400 hover:text-white">Third Link</a>
                </li>
                <li>
                  <a href="https://google.com" className="text-gray-400 hover:text-white">Fourth Link</a>
                </li>
              </nav>
            </div>
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <div className="bg-gray-800 bg-opacity-75">
          <div className="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
            <a href="https://google.com" className="flex title-font font-medium items-center md:justify-start justify-center text-white">
            ...
            <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
              <a href="https://google.com" className="text-gray-400">
                <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} className="w-5 h-5" viewBox="0 0 24 24">
                  <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z" />
                </svg>
              </a>
              <a href="https://google.com" className="ml-3 text-gray-400">
                <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} className="w-5 h-5" viewBox="0 0 24 24">
